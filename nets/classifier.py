...
class Resnet50RoIHead(nn.Module):
    def __init__(self, n_class, roi_size, spatial_scale, classifier):
        ...
        self.classifier = classifier # ————classifier指向resnet50的后半部分，即第五次特征提取、平均池化、展平和全连接
        #--------------------------------------#
        ...
        self.roi = RoIPool((roi_size, roi_size), spatial_scale) # ————RoIPooling层将建议框映射到共享特征层上并截取，并将截取结果调整到固定大小。这里使用了pytorch官方的方法
