...
#   annotation_mode为2代表获得训练用的image_data中的_train.txt、_val.txt
#--------------------------------------------------------------------------------------------------------------------------------#
annotation_mode     = 0
#--------------------------------------------------------------------------------------------------------------------------------#
...
#--------------------------------------------------------------------------------------------------------------------------------#
VOCdevkit_path  = 'VOCdevkit/PMID_2019' # 使用不同VOC数据集请修改此处路径 (゜-゜)つロ
VOCdevkit_sets  = [('PMID', 'train'), ('PMID', 'val')] # 使用不同VOC数据集请修改此处编号 (゜-゜)つロ
